        ...
        <div className="max-w-lg w-full bg-card rounded-2xl shadow-lg p-8 reveal-on-scroll fade-in">
          <div className="flex flex-col gap-6">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-semibold mb-2 mt-4">Create an Account</h2>
              <p className="text-muted-foreground">Join Magic Story Buddy for wonderful bedtime stories</p>
            </div>
