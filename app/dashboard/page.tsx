  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h2 className="text-3xl font-bold text-foreground mb-8">Parent Dashboard</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <section className="bg-card rounded-2xl shadow-md p-6 border border-border">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="ml-auto px-2 py-1 bg-chart-2/20 text-chart-2 text-xs font-medium rounded-full">
            ...
            <div className="space-y-4">
              <div className="bg-background rounded-xl p-4 border border-border">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    <div className="h-12 w-12 rounded-full bg-chart-3 flex items-center justify-center text-2xl">
                      👧
                    </div>
                    <div>
                      <h4 className="font-medium">Mila</h4>
              ...
              <div className="bg-background rounded-xl p-4 border border-border">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    <div className="h-12 w-12 rounded-full bg-chart-4 flex items-center justify-center text-2xl">
                      👦
                    </div>
                    <div>
                      <h4 className="font-medium">Joe</h4>
              ...
              <button className="w-full flex items-center justify-center gap-2 rounded-lg border border-dashed border-primary/50 p-3 text-primary hover:bg-primary/5 transition-colors">
          ...
          <section className="bg-card rounded-2xl shadow-md p-6 border border-border">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <div className="bg-chart-1/20 border-2 border-chart-1 rounded-xl p-3 text-center">
                <div className="text-xl mb-1">❤️</div>
                <div className="text-sm font-medium">Kindness</div>
              </div>
              <div className="bg-background border-2 border-transparent rounded-xl p-3 text-center">
            ...
            <p className="mt-4 text-xs text-muted-foreground">Selected themes influence which stories appear more frequently.</p>
          </section>
          ...
          <section className="bg-card rounded-2xl shadow-md p-6 border border-border md:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <button className="w-full flex items-center justify-center gap-2 rounded-lg border border-primary/20 bg-primary/5 p-2 text-primary hover:bg-primary/10 transition-colors text-sm">
              ...
              <div className="space-y-4">
                ...
                <button className="w-full flex items-center justify-center gap-2 rounded-lg border border-dashed border-primary/50 p-2 text-primary hover:bg-primary/5 transition-colors text-sm">
