...
export default function StoryModal({ isOpen, onClose, hero, place, mission, lifeSkill }: StoryModalProps) {
  ...
  const provideFallbackStory = () => {
    const fallbackStories: Record<string, string> = {
      ...
      'Drake': "Once upon a time, there was a small dragon named Drake. Drake couldn't breathe fire like the other dragons. Instead, he breathed colorful steam! One day, in the " + currentPlace + ", Drake was asked to " + currentMission.toLowerCase() + ". \"I'll try my best!\" said Drake, even though he was a little scared. Drake discovered that his colorful steam was actually very helpful for this mission! Drake learned that being different isn't bad - everyone has special talents that make them unique. Drake felt very proud. The end. Would you like to go on another adventure with Drake? Or are you ready to join Drake in Dreamland?",
      'Sparkles': "Once upon a time, there was a magical unicorn named Sparkles. Sparkles had a beautiful rainbow mane that glittered in the sunlight. One day, in the " + currentPlace + ", Sparkles was asked to " + currentMission.toLowerCase() + ". \"I'd be happy to help!\" said Sparkles with a gentle neigh. Sparkles used her unicorn magic to accomplish the mission, but found that the real magic was in sharing and being kind to others. Everyone in the " + currentPlace + " learned an important lesson about friendship that day. The end. Would you like to go on another adventure with Sparkles? Or are you ready to join Sparkles in Dreamland?",
      'Mila TanTan': "Once upon a time, there was a cute little baby named Mila TanTan. Mila had the biggest, brightest smile and the sweetest little giggle. She loved getting cuddles from her Mommy Moo and Daddy Doo. She also had two cousins she loved to see - Liam, who was 7 years old and played soccer, and Garyn, who was 8 months old with the longest eyelashes. One day, in the " + currentPlace + ", Mila was asked to " + currentMission.toLowerCase() + ". \"Goo-goo ga-ga!\" Mila babbled happily, which meant \"I'll try!\" in baby language. Mila didn't know how she would do this big task because she was just a little baby, but she was very brave. She drank some of Mommy's Magic Milk which made her feel strong. With her newfound strength and the help of her animal friends, Mila was able to " + currentMission.toLowerCase() + "! Mommy Moo and Daddy Doo were so proud of their little baby. Mila giggled and clapped her hands. She learned that with help from people who love you, even the littlest babies can do amazing things. She couldn't wait to tell her cousins Liam and Garyn all about her adventure. The end. Would you like to go on another adventure with Mila TanTan? Or are you ready to join Mila TanTan in Dreamland?",
      'Liam': "Once upon a time, there was a seven-year-old boy named Liam. Liam loved playing soccer and zooming his blue pickup trucks around. He was a big brother to baby Garyn and a cousin to Mila TanTan. One day, in the " + currentPlace + ", Liam was asked to " + currentMission.toLowerCase() + ". \"That sounds fun!\" Liam said with excitement. He put on his favorite soccer jersey for good luck and set off on his mission. Along the way, Liam had to be very brave and clever. He used his soccer skills to kick obstacles out of the way and his blue pickup truck to carry important things. Grandpa Bop tried to pack him a lunch of healthy vegetables, but Liam secretly traded it for a peanut butter sandwich instead! With determination and creativity, Liam was able to " + currentMission.toLowerCase() + "! Everyone cheered for him, especially his little brother Garyn who clapped his tiny hands. Liam learned that being a big brother means being brave and helping others. The end. Would you like to go on another adventure with Liam? Or are you ready to join Liam in Dreamland?",
